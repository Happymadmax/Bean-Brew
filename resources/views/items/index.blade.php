                        ...
                        <div class="pb-20">
                            ...
                            <div class="grid grid-cols-5 max-h-[70px] max-w-[275px] absolute top-[273.5px] border-l-2 border-t-2 border-black group-hover:border-blue-400 rounded-tl-lg">
                                <div class="col-span-3">
                                    <h3 class="pt-4 pl-2 text-sm group-hover:text-lg group-hover:font-medium text-gray-900 group-hover:text-blue-400 duration-300 ease-in-out">{{ $item['name']}}</h3>
                                    <p class="mt-1 pl-2 text-lg font-medium group-hover:text-sm group-hover:font-normal text-gray-900 group-hover:text-blue-400 duration-300 ease-in-out">item2</p>
                                </div>
                            </div>
                        </div>
                    </a>
